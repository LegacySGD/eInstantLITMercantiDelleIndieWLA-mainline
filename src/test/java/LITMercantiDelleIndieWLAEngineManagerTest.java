...
public class LITMercantiDelleIndieWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITMercantiDelleIndieWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITMercantiDelleIndieWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITMercantiDelleIndieWLAIW/InitOutcome.xml").getDocumentElement();
